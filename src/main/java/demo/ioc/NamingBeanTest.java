...
public class NamingBeanTest {
    ...
    @Test
    public void test1() {
        BeanFactory beanFactory = new ClassPathXmlApplicationContext("ioc/namingbean1.xml");
        //根据类型获取bean
    ...
    @Test
    public void test2() {
        BeanFactory beanFactory = new ClassPathXmlApplicationContext("ioc/namingbean2.xml");
        //根据id获取bean
    ...
    @Test
    public void test3() {
        BeanFactory beanFactory = new ClassPathXmlApplicationContext("ioc/namingbean3.xml");
        //根据name获取bean
        HelloApi bean = beanFactory.getBean("bean", HelloApi.class);
        bean.sayHello();
    }
    ...
    @Test
    public void test4() {
        BeanFactory beanFactory = new ClassPathXmlApplicationContext("ioc/namingbean4.xml");
        //根据id获取bean
    ...
    @Test
    public void test5() {
        BeanFactory beanFactory = new ClassPathXmlApplicationContext("ioc/namingbean5.xml");
        //根据id获取bean
        HelloApi bean1 = beanFactory.getBean("bean1", HelloApi.class);
        bean1.sayHello();
        //2根据别名获取bean
    ...
    @Test
    public void test6() {
        BeanFactory beanFactory = new ClassPathXmlApplicationContext("ioc/namingbean6.xml");
        //根据id获取bean
        HelloApi bean = beanFactory.getBean("bean", HelloApi.class);
        bean.sayHello();
